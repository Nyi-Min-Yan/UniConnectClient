...
export default function ShareModal({ visible, onClose, onShare }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center">
      ...
      <div className="relative w-full sm:max-w-md max-h-[75vh] bg-base-100 rounded-t-2xl sm:rounded-2xl shadow-2xl flex flex-col animate-fade-in-up overflow-hidden">
