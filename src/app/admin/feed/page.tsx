...
import ReactionButton, { type ReactionType } from "@/components/ui/ReactionButton";
import ShareModal from "@/components/features/feed/components/ShareModal";
import { moderateMedia, moderateText } from "@/utils/moderate";
  ...
  return (
    <div className="bg-base-100 rounded-2xl border border-base-200 shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden">
      <div className="p-4 sm:p-5">
        ...
        {post.media && (
          <div className="rounded-lg overflow-hidden border border-base-200 mb-3 max-w-2xl mx-auto">
